...
- **Primary Card:** `bg-white rounded-2xl p-4 border border-slate-100`. *Lưu ý bóng đổ (Shadow):* Dùng `shadow-sm` cho iOS, đối với Android cần thêm style `elevation: 2` để đảm bảo hiển thị shadow.
